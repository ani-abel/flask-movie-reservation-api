...
class User(db.Model):
    ...
    user_role = db.Column(db.Enum(UserRole), nullable=False, default=UserRole.ADMIN)

    # Relations
    theatres = db.relationship("Theatre", back_populates="user")
    theatre_prices = db.relationship("TicketPrice", back_populates="user")
